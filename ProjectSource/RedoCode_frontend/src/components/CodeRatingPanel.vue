  ...
  <div>
    <div class="CodeRatingContainer">
      <div class="RatingPanelContaier" >
        <div class="RatingPanelHeader">Your execution time compared to maximum</div>
        <div class="RatingPanel">
            <div class="DougnoutInsidesContainer MsText">
                {{ props.ExecutionTime}} ms
            </div>
          <Doughnut :data="ExeceutionData" :options="PieChartOptions"  class="DugoutContainer"/>
        </div>
      </div>
      ...
      <div class="RatingPanelContaier">
        ...
        <div class="RatingPanel">
          ...
          <Doughnut :data="ProcentData" :options="PieChartOptions"  class="DugoutContainer"/>
        </div>
      </div>
  ...
  datasets: [
    {
      ...
      data: [props.ExecutionTime, props.MaxExecutionTime-props.ExecutionTime],
    },
  ],
};
const ProcentData = {
  labels: ["% of solutions worse than yours","% of solutions better than yours"],
  datasets: [
    {
      backgroundColor: ["#a463ac", "#ffffff",],
