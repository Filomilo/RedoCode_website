...
<template>
  ...
  <div class="CodeEditorPanelSetting">
    <Dropdown
      :modelValue="ApiConnectionStore.codeRunnerConnection.codeRunnerState.codeRunnerType"
...
const onChangeLnageugeDropDown = (lang: any) => {
  if (
    lang.value! !== ApiConnectionStore.codeRunnerConnection.codeRunnerState.codeRunnerType
  ) {
