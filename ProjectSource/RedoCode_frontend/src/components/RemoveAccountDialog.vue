  ...
  <div>
    ...
    >
      <div class="confirmButtonContainer">
        <Button
          id="not_remove_account_button"
          class="buttonBase"
          label="NOT remove account"
          raised
          rounded
          @click="declineRemoveAccount"
        />
        <Button
          id="do_remove_account_button"
          class="buttonBase dangerButton"
          label="Remove account"
          severity="danger"
          raised
          rounded
...
<script lang="ts" setup>
  ...
  const confirmRemoveAccount = () => {
    ...
    EndpointAccess.authorized
      .postRemoveAccount(password_input.value)
      .then(() => {
        console.log('Success removed account')
