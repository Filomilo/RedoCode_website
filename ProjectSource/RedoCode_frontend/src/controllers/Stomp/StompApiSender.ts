...
public readonly authenticationStomp = (mesage: AuthenticationResponse) => {
    ...
    public readonly runRawCode = (mesage: RawCodeToRunMessage) => {
      ...
      public readonly runExercsieIdValidationCode = (mesage: ExerciseIdToRunMessage) => {
        this._stompApiConnection.sendMessage(
      ...
      public readonly runExerciseTestsCode = (mesage: ExerciseTestToRunMesseage) => {
        this._stompApiConnection.sendMessage(
      ...
      public readonly runExerciseCreatorValidationCode = (mesage: ExercsieCreatorValidationMesage) => {
        this._stompApiConnection.sendMessage(
