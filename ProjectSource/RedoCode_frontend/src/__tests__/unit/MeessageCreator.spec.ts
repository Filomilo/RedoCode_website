...
import ExerciseCreatorController, { TestsIndexed } from '@/controllers/CodeRunner/ExerciseCreatorControlller'
...
describe('MessageCreaator', () => {
  it('generate ExercsieCreatorValidationMesage', () => {
    ...
    let exerciseCreatorController: ExerciseCreatorController= new ExerciseCreatorController();
    ...
    MessageCreator.createExercsieCreatorValidationMesage(exerciseCreatorController);
