    ...
    export function setInputType(type: TYPES, size: SIZE) {
      switch (type) {
        case TYPES.STRING:
          ...
          break
        case TYPES.INT:
          cy.get('#radio-input-int').click()
          break
        case TYPES.FLOAT:
          cy.get('#radio-input-float').click()
          break
      }

      switch (size) {
        case SIZE.SINGLE:
          cy.get('#radio-input-single').click()
          break
        case SIZE.ARRAY:
          cy.get('#radio-input-array').click()
          break
        case SIZE.DOUBLE_ARRAY:
          cy.get('#radio-input-2d-array').click()
          break
      }
    }
    ...
    export function setOutputType(type: TYPES, size: SIZE) {
      switch (type) {
        case TYPES.STRING:
          ...
          break
        case TYPES.INT:
          cy.get('#radio-output-int').click()
          break
        case TYPES.FLOAT:
          cy.get('#radio-output-float').click()
          break
      }

      switch (size) {
        case SIZE.SINGLE:
          cy.get('#radio-output-single').click()
          break
        case SIZE.ARRAY:
          cy.get('#radio-output-array').click()
          break
        case SIZE.DOUBLE_ARRAY:
          cy.get('#radio-output-2d-array').click()
          break
      }
    }
