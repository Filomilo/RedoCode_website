  ...
  it('passes', () => {
    describe('template spec', () => {
      it('passes', () => {
        ...
        cy.get(
          'html body div#app html div#MainPageContainer div.BackGroundContainer main#ContentConatiner.PlayGroundBase div.heightLimit div.p-splitter.p-component.p-splitter-horizontal div.p-splitter-panel div.CodeEditorPanelSetting div.CodeEditorPlayButton button.p-button.p-component svg'
        ).click()
        cy.get(
          'html body div#app html div#MainPageContainer div.BackGroundContainer main#ContentConatiner.PlayGroundBase div.heightLimit div.p-splitter.p-component.p-splitter-horizontal div.p-splitter-panel div.CodeResultContainer div.ConsoleResultConsoleCOntainer div.ConsoleResultConsoleCOntainerText'
