...
class ExerciseInfoValidationTest {
    ...
    @ParameterizedTest
    @MethodSource ("com.redocode.backend.DataProviders.IncorrectExerciseParamatersProviders#incorrectAmountAutoTest")
    ...
    @ParameterizedTest
    @MethodSource ("com.redocode.backend.DataProviders.IncorrectExerciseParamatersProviders#incorrectLengthRange")
    ...
    @ParameterizedTest
    @MethodSource ("com.redocode.backend.DataProviders.IncorrectExerciseParamatersProviders#incorrectArrayRange")
    ...
    @ParameterizedTest
    @MethodSource ("com.redocode.backend.DataProviders.IncorrectExerciseParamatersProviders#incorrectStringRange")
    ...
    @ParameterizedTest
    @MethodSource ("com.redocode.backend.DataProviders.IncorrectExerciseParamatersProviders#incorrectTime")
    ...
    @ParameterizedTest
    @MethodSource ("com.redocode.backend.DataProviders.IncorrectExerciseParamatersProviders#executionTime")
