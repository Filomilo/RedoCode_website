...
class CodeRunnersConnectionControllerTest {
  ...
  void testAutoStartFromQueue() {
    ...
    for (int i = 0; i < CodeRunnersController.maxAmountOfVm; i++) {
      ...
      redoCodeController.addConnectedUser(user);
      CodeRunnerRequest req =
          CodeRunnerRequest.builder().user(user).codeRunnerType(getRandomCodeRunnerType()).build();
      codeRunnersController.requestVm(req);
    }
    ...
    CodeRunnerRequest req1 =
        CodeRunnerRequest.builder().codeRunnerType(getRandomCodeRunnerType()).user(user1).build();
    ...
    CodeRunnerRequest req2 =
        CodeRunnerRequest.builder().codeRunnerType(getRandomCodeRunnerType()).user(user2).build();
