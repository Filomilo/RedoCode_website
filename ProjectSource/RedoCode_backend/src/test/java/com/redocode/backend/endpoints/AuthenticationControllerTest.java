...
//localhost:8080/public/auth/register
    ...
    void registerUser() {
        ...
        assertEquals(
                user.getNickname(),newUser.getNickname()
        );
    ...
    void login() {
        ...
        assertEquals(jwtService.generateToken(user),response.getToken());
    ...
    @ParameterizedTest
    @ValueSource(strings = {"", "                     ", "123","12345678901234567890","password+123","Passssssssword","Passsssssword123","Passssssword_______","Admin+123"})
