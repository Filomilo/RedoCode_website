...
public class HelathCheckEndPointTest {
    ...
    assertEquals(
        ...
        (String)
            this.restTemplate.getForObject(
                "http://localhost:" + port + "/public/healthcheck/hello", String.class));
  }
  ...
  public void helloSecuredUnauthetnicated() {
    ...
    assertNull(
        this.restTemplate.getForObject(
            "http://localhost:" + port + "/secure/healthcheck/hello", String.class));
  }
    ...
    assertEquals(
        ...
        ((ResponseEntity<String>)
                this.restTemplate.exchange(
                    getFullEndpoint("/secure/healthcheck/hello"),
                    HttpMethod.GET,
                    entity,
                    String.class))
            .getBody());
