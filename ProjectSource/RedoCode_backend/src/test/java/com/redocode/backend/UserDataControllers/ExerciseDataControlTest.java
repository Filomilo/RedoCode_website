...
//        this.solutionProgramsRepository.deleteAll();
        ...
        this.userToCheck=usersRepository.save(User.builder()
                ...
                .build());
        User userAuthor=usersRepository.save(User.builder()
                .email(UUID.randomUUID()+"mail@mail.com")
                .description("desc")
                .type(User.USER_TYPE.AUTHENTICATED)
                .nickname("nickname")
                ...
                .password("PASSWORD+123")
                .build());
       this.exerciseToCheck=exerciseRepository.save(
                Excersize.builder()
                        .excersizeName("Test")
        ...
        this.solutionProgramsRepository.save(SolutionPrograms.builder()
                        .date(new Date())
                        .code("CODE")
    ...
    void getResultDataForExerciseOfUser() {
        ResultData resultData= exerciseDataControl.getResultDataForExerciseOfUser(this.exerciseToCheck.getId(),this.userToCheck.getId());
        ...
        //add User better
        User userBetter=usersRepository.save(User.builder()
                .email(UUID.randomUUID()+"mail@mail.com")
                .description("desc")
                .type(User.USER_TYPE.AUTHENTICATED)
                .nickname("nickname")
        ...
        this.solutionProgramsRepository.save(SolutionPrograms.builder()
                ...
                .build());
        ResultData resultDataWorse= exerciseDataControl.getResultDataForExerciseOfUser(this.exerciseToCheck.getId(),this.userToCheck.getId());
        assertEquals(0,resultDataWorse.getBetterThanPercent());

        // add User Worse
        User userWorse=usersRepository.save(User.builder()
                .email(UUID.randomUUID()+"mail@mail.com")
                .description("desc")
                .type(User.USER_TYPE.AUTHENTICATED)
                .nickname("nickname")
        ...
        this.solutionProgramsRepository.save(SolutionPrograms.builder()
                ...
                .build());
        ResultData resultDataBetter= exerciseDataControl.getResultDataForExerciseOfUser(this.exerciseToCheck.getId(),this.userToCheck.getId());
