...
class UserDataControlTest {
  ...
  private static String img =
      "iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAQUlEQVR42mOYsFbtPzk4daIMGDNQzQCYALHYKJcPjCk3oDPO+j8IJ1tpkoUpN2Bxlc9/EIYZRCweNWB4GTDgKREAV3gQO7H1SHUAAAAASUVORK5CYII=";
  ...
  void getUserDetails() {
    ...
    assertDoesNotThrow(
        () -> {
          ...
          assertEquals(
              userOnDb.getEmail().substring(0, 1) + "***" + "@mail.com",
              userDetailsMessage.getEmailSignature());
