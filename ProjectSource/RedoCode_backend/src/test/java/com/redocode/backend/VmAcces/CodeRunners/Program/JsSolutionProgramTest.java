...
public class JsSolutionProgramTest {
  ...
  void runProgramJsReturnInt(Integer val) throws ContainerException {
  ...
  void runProgramJsReturnFloat(Float val) throws ContainerException {
    log.info("Code runner cpp return");
    Program program =
        ProgramFactory.createSolutionProgram()
  ...
  void runProgramJsReturnString(String val) throws ContainerException {
    log.info("Code runner cpp return");
    Program program =
        ProgramFactory.createSolutionProgram()
            .setSolutionCodeRunner(CODE_RUNNER_TYPE.JS_RUNNER)
  ...
  void runProgramJSReturnStringArray(String[] val) throws ContainerException {
    log.info("Code runner cpp return");
  ...
  void runProgramJsReturnIntArray(Integer[] val) throws ContainerException {
    log.info("Code runner cpp return");
  ...
  void runProgramJsReturnIntArray(Float[] val) throws ContainerException {
    log.info("Code runner cpp return");
  ...
  void runProgramJsReturnStringDoubleArray(String[][] val) throws ContainerException {
    log.info("Code runner cpp return");
  ...
  void runProgramJsReturnIntDoubleArray(Integer[][] val) throws ContainerException {
    log.info("Code runner cpp return");
  ...
  void runProgramJsReturnFloatDoubleArray(Float[][] val) throws ContainerException {
    log.info("Code runner cpp return");
