 ...
 * <br/><br/>
 * Request handled by this handler must implements interfaces {@link  IExerciseIdRequest IExerciseIdRequest},
    ...
    RequestBase handle(RequestBase request) throws RequestHadndlingException {
        ...
        SpecifiedSingleDatabaseExerciseTestRequest specifiedSingleDatabaseExerciseTestRequest=
                SpecifiedSingleDatabaseExerciseTestRequest.builder()
                        ...
                        .lengthRange(new Range(excersize.getValueLengthRangeMin(),excersize.getValueLengthRangeMax()))
                        .xArrayRange(excersize.getInputType().isArray()||excersize.getInputType().isDoubleArray()? new Range(excersize.getArrayXLengthRangeMin(),excersize.getArrayXLengthRangeMax()):null)
                        .yArrayRange(excersize.getInputType().isDoubleArray()?new Range(excersize.getArrayYLengthRangeMin(),excersize.getArrayYLengthRangeMax()):null)
                        .build();
