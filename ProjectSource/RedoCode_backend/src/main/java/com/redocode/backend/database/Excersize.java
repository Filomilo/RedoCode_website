...
public class Excersize {
  ...
  @Column(name = "array_x_length_range_min")
  Integer arrayXLengthRangeMin;

  @Column(name = "array_x_length_range_max")
  Integer arrayXLengthRangeMax;

  @Column(name = "array_y_length_range_min")
  Integer arrayYLengthRangeMin;

  @Column(name = "array_y_length_range_max")
