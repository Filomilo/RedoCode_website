...
/**
 * Message request that is used mainly to run chain of resposiblity in situation when user runs
 * tests on his code without yet submiting solution
 */
@Getter
@SuperBuilder
@Setter
public class SingleDatabaseExerciseTestRequest extends RequestBase
    implements IExerciseIdRequest, ISolutionCodesRequest {
