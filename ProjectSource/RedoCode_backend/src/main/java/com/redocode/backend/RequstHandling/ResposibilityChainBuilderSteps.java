...
public class ResposibilityChainBuilderSteps {
  @NotNull BaseRequestHandler baseRequestHandlerCurrent;
  @NotNull BaseRequestHandler startRequest;
  BiFunction<User, ExecutionResponseBase, Void> messagehandler;

  public ResposibilityChainBuilderSteps(
      BiFunction<User, ExecutionResponseBase, Void> messagehandler) {
  ...
  public ResposibilityChainBuilderSteps next(BaseRequestHandler baseRequestHandler) {
    ...
    if (startRequest == null) startRequest = baseRequestHandler;
    else this.baseRequestHandlerCurrent.setNextRequestHandler(baseRequestHandler);
