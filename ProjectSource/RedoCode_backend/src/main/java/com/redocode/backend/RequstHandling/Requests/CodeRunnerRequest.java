...
public class CodeRunnerRequest extends RequestBase implements Comparable {
  ...
  public CodeRunnerRequest(User user, CodeRunnerRequestMessage requestMessageSource) {
    ...
    // "+requestMessageSource.getCodeRunnerType() );
    //       }
  ...
  public int compareTo(Object o) {
    ...
    if (this.user.getUserType() == crm.getUser().getUserType()
        && this.requestTime != null
        && crm.requestTime != null) {
      log.info(
          "Comapring "
              ...
              + crm.getRequestTime()
              + ": "
              + this.requestTime.compareTo(crm.getRequestTime()));
