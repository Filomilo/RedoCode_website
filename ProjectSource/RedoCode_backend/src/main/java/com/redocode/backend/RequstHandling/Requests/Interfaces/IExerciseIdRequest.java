...
/**
 * interface used in chain of resposbility to handle request realted to a specifc exercise id in
 * database, it declares method to get id of that exercise
 *
 * @see com.redocode.backend.RequstHandling.Requests.SingleDatabaseExerciseTestRequest
